...
import { Sparkles, Mail, Lock, UserPlus, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-md w-full space-y-6 bg-white p-8 sm:p-10 rounded-3xl border border-[#C8E6E1] shadow-sm">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-[#486D7A]">
              Join the Heal With Heer community and access transformation programs.
            </p>
          </div>
          ...
          <div className="text-center pt-2 text-xs text-[#486D7A]">
            ...
            <Link to="/login" className="font-bold text-[#287687] hover:underline">
              Sign In
            </Link>
          </div>
